...
type_queryset = data_models.Type.objects.all()
type_serializer = data_serializers.TypeSerializer(type_queryset, many=True).data
type_data = [{'id': item['id'], 'name': item['name']} for item in type_serializer]
